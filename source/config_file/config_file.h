...
#define MAX_PHYSICAL_WRITE_RANGES 8
...
struct emulator_config {
  ...
  unsigned int physical_write_range_count;
  unsigned int physical_write_low[MAX_PHYSICAL_WRITE_RANGES];
  unsigned int physical_write_high[MAX_PHYSICAL_WRITE_RANGES];
  unsigned char force24bit;
};
